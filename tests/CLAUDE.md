...
tests/
  ...
  integration/          # Playwright — page-level interactions
    ...
    history-custodial.spec.ts # /history "Ke/Dari wallet custodial saya" marker: to/from the wallet, manual address, no wallet, all-lowercase address, mobile cards (USDX-653)
